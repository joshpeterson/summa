...
class ArticlesControllerViewTest < ActionController::TestCase
  ...
  test 'view for first article has proper first statement objection again' do
    get_article('1')
  ...
  test 'view for first article has proper second statement objection again' do
    get_article('1')
  ...
  test 'view for second article has proper second statement objection' do
    get_article('2')
    assert_match('Objection 4: Fourth objection statement',
                 @statements[1].inner_html)
  end
